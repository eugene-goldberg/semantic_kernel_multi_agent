...
def main():
    ...
    print("Testing orchestrated agents on Azure with Calculator Agent")
    ...
    test_messages = [
        ...
        "What's the determinant of matrix [[1,2],[3,4]]?",
    ...
    for i, message in enumerate(test_messages):
        ...
        if any(word in message.lower() for word in ["weather", "temperature", "forecast", "rain", "sunny"]):
            agent_type = "weather"
        elif any(word in message.lower() for word in ["calculate", "determinant", "matrix", "equation", "solve", "square root", "derivative"]):
